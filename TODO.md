...
- [x] **Fix Backend URL**: Resolve "No scheme supplied" error by robustly handling BACKEND_URL in frontend and capturing it correctly in CD (added robust quoting to handle special characters in secrets).
